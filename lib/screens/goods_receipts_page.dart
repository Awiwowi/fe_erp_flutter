                    ...
                    children: [
                      ...
                      DropdownButtonFormField<int>(
                        decoration: const InputDecoration(
                          labelText: "Pilih Purchase Order (Sent)",
                        ),
                        value: selectedPoId,
                        isExpanded: true,
                        ...
                        onChanged: (val) {
                          setStateDialog(() {
                            ...
                            var selectedPO = _sentPurchaseOrders.firstWhere(
                              (p) => p['id'] == val,
                            );
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "Order: ${item['qty_ordered']} ${item['unit_name']}",
                                    style: const TextStyle(
                                      fontSize: 12,
                                      color: Colors.grey,
                                    ),
                  ...
                  onPressed: () async {
                    if (selectedPoId == null || selectedWarehouseId == null) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text("Pilih PO dan Gudang!")),
                      );
                      return;
                    }
                    ...
                    bool success = await DataService().createGoodsReceipt(
                      payload,
                    );
                    ...
                    if (success) {
                      ...
                      messenger.showSnackBar(
                        const SnackBar(
                          content: Text("Berhasil membuat Goods Receipt"),
  ...
  void _postGR(int id) async {
    bool confirm =
        await showDialog(
          ...
          builder: (ctx) => AlertDialog(
            ...
            content: const Text(
              "Stok akan bertambah dan data tidak bisa diedit lagi. Lanjutkan?",
            ),
            actions: [
              TextButton(
    ...
    if (confirm) {
      ...
      if (success) {
        ...
        messenger.showSnackBar(
          const SnackBar(
            content: Text("GR Berhasil Diposting!"),
            backgroundColor: Colors.green,
          ),
        );
      } else {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (gr['delivery_note_number'] != null)
                                Text(
                                  "Surat Jalan: ${gr['delivery_note_number']}",
                                  style: const TextStyle(
                                    fontSize: 12,
